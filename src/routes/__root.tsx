...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Taskgenie — Productivity Assistant" },
      ...
      { name: "author", content: "Taskgenie" },
      { property: "og:title", content: "Taskgenie — Productivity Assistant" },
      ...
      { name: "twitter:title", content: "Taskgenie — Productivity Assistant" },
